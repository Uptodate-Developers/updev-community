    ...
    <div class="px-4 py-4 bg-gray-50">
        <div class="flex justify-between">
            <div class=" flex items-center space-x-2">
                <a-avatar :style="{backgroundColor: '#0068B7', verticalAlign: 'middle'}" :size="70"><span style="line-height: 70px" class="block text-2xl font-semibold">JM</span></a-avatar>
                <div>
                    <h2>Julius Nyerere</h2>
                    <h3 class=" text-gray-400">@juliusnyere</h3>
                </div>
            </div>
        ...
        <div class=" mt-3 md:flex justify-between items-center md:space-x-8">
            <p class=" text-sm text-gray-800 max-w-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <div class=" space-x-2 flex">
                <button><img class=" h-8 md:h-24 lg:h-10 " src="../../../assets/icons/githubblack.svg" alt="Github logo"/></button>
                <button><img class=" h-8 md:h-24 lg:h-10 " src="../../../assets/icons/twitter.svg" alt="Twitter logo"/></button>
                 <button><img class=" h-8 md:h-24 lg:h-10 " src="../../../assets/icons/facebook.svg" alt="Facebook  logo"/></button>
            </div>
        </div>
    </div>
</template>