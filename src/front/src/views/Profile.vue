<template>
    ...
    <div v-if="!isLoading" class="md:hidden space-y-1">
        ...
        <button @click="onLogout" class="self-stretch  bg-gray-50 text-red-500 px-2 py-2 space-x-4 hover:text-red-500 focus:outline-none flex justify-center items-center border ">
